...
Dari analisis data dan heatmap yang telah dilakukan, terlihat bahwa hubungan antara status persetujuan izin dengan kualitas lingkungan secara keseluruhan ternyata cukup lemah. Meskipun ada korelasi positif kecil sebesar 0,20 antara status izin yang disetujui dengan kerapatan pohon, yang menandakan proyek berizin cenderung memiliki pohon yang sedikit lebih rapat, hubungan dengan kualitas air justru menunjukkan nilai negatif kecil (-0,14). Hal ini berarti, proyek yang sudah mendapatkan izin resmi belum tentu menjamin kualitas air yang lebih baik, seperti halnya memiliki kartu anggota klub berkebun yang memang bisa membuat kebun terlihat lebih rimbun, tapi tidak otomatis menjernihkan air kolam di dalamnya. Dengan demikian, izin saja tidak cukup untuk memastikan kondisi alam yang jauh lebih optimal. Namun, di balik korelasi ekologi yang rendah ini, terdapat peluang untuk mendeteksi risiko hukum yang lebih tinggi, seperti ketidaksesuaian antara izin dan progres lapangan yang bisa mengindikasikan batas lahan yang lemah dan potensi sengketa besar. Selain itu, kualitas ekologi yang rendah di area berizin mungkin menjadi tanda adanya pelanggaran atau kelalaian pengelolaan. Melalui analisis multi-dimensi seperti ini, platform MangroveChain dapat secara dini menandai proyek-proyek dengan risiko hukum tinggi, sehingga dana dari donor atau investor tidak mengalir ke inisiatif yang rawan gagal secara legal. Lebih lanjut, hal ini juga membantu pemerintah dalam menargetkan intervensi hukum tepat waktu, sebelum sengketa atau kerusakan lingkungan semakin parah.
